...
const notifications = {
	...
	discord: {
		...
		notifyGroupSeries: {
			...
			'750W': envOrArray(process.env.DISCORD_NOTIFY_GROUP_750W),
			'850W': envOrArray(process.env.DISCORD_NOTIFY_GROUP_850W),
			'1000W': envOrArray(process.env.DISCORD_NOTIFY_GROUP_1000W),
			'FOCUS GX': envOrArray(process.env.DISCORD_NOTIFY_GROUP_FGOCUSGX),
			'FOCUS PX': envOrArray(process.env.DISCORD_NOTIFY_GROUP_FGOCUSPX),
			'PRIME GX': envOrArray(process.env.DISCORD_NOTIFY_GROUP_PRIMEGX),
			'PRIME PX': envOrArray(process.env.DISCORD_NOTIFY_GROUP_PRIMEPX),
			'PRIME TX': envOrArray(process.env.DISCORD_NOTIFY_GROUP_PRIMETX),
